...
parser.add_argument('--output_dir', type=str, default="./output_train_gat/ifashion/difashion_gat_ug_v5_stage3/only_texture")
parser.add_argument('--eval_version', type=str, default="")
parser.add_argument('--ckpts', type=str, default=["37000"])
...
def main():
    ...
    if args.dataset == "ifashion":
        ...
        args.output_dir = './output_train_gat/ifashion/difashion_gat_ug_ema/notexture'
