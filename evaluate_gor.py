...
parser.add_argument('--output_dir', type=str, default="./output_train_gat/ifashion/difashion_gat_ug_ema/normal")
parser.add_argument('--dataset', type=str, default="polyvore")
parser.add_argument('--eval_version', type=str, default="")
parser.add_argument('--ckpts', type=str, default=["48000"])
parser.add_argument('--task', type=str, default="GOR")
...
def main():
    ...
    if args.dataset == "ifashion":
        ...
        args.output_dir = './output_train_gat/ifashion/difashion_gat_ug_ema/normal'
        ...
        args.output_dir = './output_train_gat/polyvore/difashion_gat_ug_ema/normal'
    else:
    ...
    cid_to_label = np.load('../Evaluation/finetuned_inception/cid_to_label.npy', allow_pickle=True).item() # map cid to inception predicted label
    ...
    img_folder_path = "../semantic_category"
    ...
    for ckpt in ckpts:
        ...
        _, _, img_trans = open_clip.create_model_and_transforms('ViT-H-14', pretrained="./laion2b-s32b-b79K/open_clip_pytorch_model.bin")
        ...
        is_acc, is_entropy, _, is_score, _ = eval_utils.calculate_inception_score_given_data(
            gen_dataset,
            cate_dataset,
            model_path='../Evaluation/finetuned_inception/Inception-finetune-epoch300',
